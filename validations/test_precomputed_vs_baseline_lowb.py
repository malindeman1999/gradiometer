...
from europa.config import GridConfig, ModelConfig, AmbientConfig
...
def main() -> None:
    cache_path = os.path.join("data", "gaunt_cache_wigxjpf", "gaunt_wigxjpf.pt")
    if not os.path.exists(cache_path):
        print(f"Gaunt cache not found at {cache_path}; run scripts/save_gaunt_sparse_wigxjpf.py first.")
        return
    ...
    solve_spectral_self_consistent_sim_precomputed(test, cache_dir="data/gaunt_cache_wigxjpf")
